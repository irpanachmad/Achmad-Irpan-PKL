...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark"><i class="fa fa-thermometer-half ml-1 mr-1"></i> Tambah Data Kondisi Inventaris</h4>
                </div><!-- /.col -->
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td align="center" width="7%">
                                        <button class="btn btn-xs btn-success" id="select" data-id_barang="<?= $row['id_barang'] ?>" data-kd_barang="<?= $row['kd_barang'] ?>" data-nm_barang="<?= $row['nm_barang'] ?>" data-tahun="<?= $row['tahun'] ?>" data-nm_ruang="<?= $row['nm_ruang'] ?>" data-kondisi="<?= $row['kondisi'] ?>">
                                            Pilih
                                        </button>
                                    </td>
                                </tr>
