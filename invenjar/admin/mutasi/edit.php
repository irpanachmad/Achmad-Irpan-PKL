...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark"><i class="fa fa-cubes ml-1 mr-1"></i> Edit Data Mutasi Inventaris</h4>
                </div><!-- /.col -->
                        ...
                        <div class="card-body" style="background-color: white;">
                            <form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="tahun" class="form-control" value="<?= $row['tahun'] ?>" readonly>
                                    </div>
                                </div>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td align="center" width="7%">
                                        <button class="btn btn-xs btn-success" id="select" data-id_barang="<?= $row['id_barang'] ?>" data-kd_barang="<?= $row['kd_barang'] ?>" data-nm_barang="<?= $row['nm_barang'] ?>" data-tahun="<?= $row['tahun'] ?>" data-id_ruang="<?= $row['id_ruang'] ?>">
                                            Pilih
                                        </button>
                                    </td>
                                </tr>
